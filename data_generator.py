...
from object_resource import InterviewQuestions, InterviewAnswers, InterviewData
from prompts import (
    SYSTEM_TEMPLATE,
...
class DataGenerator():
    ...
    def generate_interview_app_data(self, company: str, description: str, mock_data: bool) -> InterviewData:
